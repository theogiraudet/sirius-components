...
public class ParametricSVGImageRegistry implements IParametricSVGImageRegistry {
    ...
    public List<ParametricSVGImage> getImages() {
        return List.of(new ParametricSVGImage(UUID.nameUUIDFromBytes("Package".getBytes()), "Package", "parametricSVGs/package.svg"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
                new ParametricSVGImage(UUID.nameUUIDFromBytes("Class".getBytes()), "Class", "parametricSVGs/class.svg")); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    }
}
