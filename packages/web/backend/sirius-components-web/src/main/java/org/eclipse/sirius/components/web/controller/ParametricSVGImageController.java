...
public class ParametricSVGImageController {
    ...
    private final IParametricSVGImageFactory svgImageService;

    private final Timer timer;

    public ParametricSVGImageController(IParametricSVGImageFactory svgImageService, MeterRegistry meterRegistry) {
        this.svgImageService = Objects.requireNonNull(svgImageService);
    ...
    public ResponseEntity<Resource> getImage(HttpServletRequest request) {
        ...
        byte[] svg = this.svgImageService.createSvg(imageType, attributesValues);
